...
#Use this command as above command will not work
bin/kafka-configs.sh --bootstrap-server kafka1:9092 --entity-type topics --entity-name __consumer_offsets --add-config min.insync.replicas=1 --alter
